...
{
    [SerializeField]
    Sprite spriteAchievement;
    [SerializeField]
    TextMeshPro labTitle;
    [SerializeField]
    TextMeshPro labProgress;
    [SerializeField]
    Button buttonReward;
    [SerializeField]
    //UIGrid levelGrid;
    ...
    public void SetData(FMAchievementItem item, string rewardIcon)
    {
        ...
        spriteAchievement.name = States[States.Length - 1] == FMAchievementState.Claimed ?
        ...
        for (int i = 0; i < uachv.States.Length; i++)
        {
            ...
            //Sprite levelSprite = levelGrid.GetChildList()[i].gameObject.GetComponent<UISprite>();
    ...
    public void UpdateData()
    {
        ...
        if (progress >= Achievement.AmountRequired[CurrentIndex])
        {
            ...
            ProgressBar.gameObject.SetActive(false);
            //buttonReward.GetComponentInChildren<Label>().text = "Get Reward";
        }
    ...
    {
        //buttonReward.GetComponentInChildren<Label>().text = "Claimed";
